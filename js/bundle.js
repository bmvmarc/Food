...
function calc() {
  ...
  let sex, ratio, weight, height, age, kcal;
...
function forms(formSelector, modalSelector, modalTimerId) {
  ...
  function addPostHandler(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', dataJSON).then(data => {
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  window.addEventListener('scroll', openModalEndOfPage); // close
...
document.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_5__.openModal)('.modal', modalTimerId), 3000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__.default)('.tabcontent', '.tabheader__items', '.tabheader__item', 'tabheader__item_active');
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__.default)('.timer', '2021-08-25T21:00:00');
